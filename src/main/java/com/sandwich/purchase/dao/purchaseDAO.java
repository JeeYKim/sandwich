...
public class purchaseDAO extends AbstractDAO {
	   ...
	   @SuppressWarnings("unchecked") 
	   public List<Map<String, Object>> purchaseListone(Map<String, Object> map) throws Exception{
	       return (List<Map<String, Object>>)selectList("purchase.purchaseListone", map);
	   }
	   ...
	   public void basketdelete(Map<String, Object> map)throws Exception{
		   delete("purchase.basketdelete", map);
	   }
