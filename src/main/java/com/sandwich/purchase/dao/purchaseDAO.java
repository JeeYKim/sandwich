...
public class purchaseDAO extends AbstractDAO {
	   ...
	   public List<Map<String, Object>> basketListOne(Map<String, Object> map) throws Exception{
		...
		@SuppressWarnings("unchecked")
		public List<Map<String, Object>> countfind(String PURCHASE_SMALLTYPE) {
			// TODO Auto-generated method stub
			return (List<Map<String, Object>>) selectOne("purchase.countfind", PURCHASE_SMALLTYPE);
		}

		
		@SuppressWarnings("unchecked")
		public List<Map<String, Object>> countfind2(Map<String, Object> map) {
			// TODO Auto-generated method stub
			return (List<Map<String, Object>>) selectOne("purchase.countfind2");
		}		   
	   ...
	   public void countSubPurchase(List<Map<String, Object>> list4)throws Exception{
		   update("purchase.countSubPurchase", list4);
	   }
