package com.sandwich.DIY_Board.service;
...
import com.sandwich.DIY_Board.dao.MemberDiyDao;
import com.sandwich.common.DiyImageUtils;
...
*/		return memberDiyDao.diyList(map);
	...
	public void diyInsert(Map<String,Object>map,HttpServletRequest request) throws Exception{
		...
		if(multipartHttpServletRequest.getFile("DIY_IMAGE").getSize() > 0){
