			...
			<form id="frm" name="frm" action="join.jy" method="post">
				...
				<ul class="section-body" style="list-style: none;">
					...
					<li class="password-check">
						<div class="item-label col-lg-3 col-md-4">
							<label for="input-password-check"> <strong>* 비밀번호 확인</strong>
							</label>
						</div>
						<div class="col-lg-21 col-md-20">
							<input type="password" id="input-password-check"class="xx-control" 
							value="" name="password_confirm" label="비밀번호"
					...
					<li class="mail">
						...
						<div class="col-lg-21 col-md-20">
							<input type="text" name="MEMBER_EMAIL" class="xx-control x01"
					...
					<div class="btnArea">
						...
						<input class="effect effect-5" type="button" onclick="checkpw();" value="가입완료"/>
					</div>
				</ul>
				</section>
			</form>
