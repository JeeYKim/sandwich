...
<head><link rel="stylesheet" type="text/css" href="/sandwich/resources/css/emailauth.css" /> 
<script type="text/javascript">
function modal_email()
{
	//부모창에서 이동할 경로 설정
	window.name="/sandwich/joinForm";
	
	//팝업창(자식창) 경로 설정
	window.open('/sandwich/modal_email.jy','','toolbar=no,menubar=no,location=no,height=650,width=600'); 
} 
</script>
...
<div class="container">
	<div class="contents1" style="margin-bottom:50px;">         
	      ...
	      <div class="xans-member-joinAgreement">
	         ...
	         <div class="agreeArea" style="width:1145px; margin-top:20px;">
	            <h3>불타는 샌드위치 회원가입을 위해 본인인증을 시작합니다.</h3>
	            <div class="agree">
	            <p>이메일 인증을 통하여 본인인증을 진행할 수 있습니다.<br>
			본인인증을 위해 입력하신 개인정보는 회원가입을 위해서 확인하는 것이며,<br>
			수집된 정보는 본인인증 외 어떠한 용도로도 사용되거나 저장되지 않으므로 안심하시기 바랍니다.</p>
	...
	<div style="margin-bottom:80px; text-align: center; margin-right: 150px; padding-bottom:10px;">
