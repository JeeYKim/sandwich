...
<body>
	<center>
		<form action="/sandwich/findPwForm.jy" method="post">
	...
	<tr>
		...
		<td rowspan="3">
		<input type="submit" value="비밀번호 찾기" style="WIDTH: 90pt; HEIGHT: 60pt">
		</td>
	</tr>
	<tr>
		<td align="center">
	...
	<tr>
		...
		<td>
		<input  type="button" value="아이디 찾기" onClick="javascript:location.href='/sandwich/findIdForm.jy'">
