					...
					<div class="row">
						<div class="col-sm-12">
							<table class="table table-bordered table-hover dataTable no-footer"
								...
								<tbody>
								<c:forEach var="ingredientStaffList"  items="${ingredientStaffList}" varStatus="stat">
							 	<c:url var="SandwichModify" value="/ingredientView.jy" >
									<c:param name="SANDWICH_NO" value="${ingredientStaffList.SANDWICH_NO}" />
								</c:url>
								<c:url var="SandwichDelete" value="/ingredientDelete.jy" >
									...
									<tr class="gradeA even" role="row">
										...
										<td style="text-align:center;vertical-align:middle;">${ingredientStaffList.SANDWICH_AMOUNT}개</td>
										<td style="text-align:center;vertical-align:middle;"><fmt:formatDate value="${ingredientStaffList.SANDWICH_ORDERDATE}" pattern="YY.MM.dd HH:mm" /></td>			
										<td style="text-align:center;vertical-align:middle;"><fmt:formatDate value="${ingredientStaffList.SANDWICH_ENDDATE}" pattern="YY.MM.dd HH:mm" /></td>								
								...
								<!--  등록된 상품이 없을때 -->
									<c:if test="${ingredientStaffList}==0">
