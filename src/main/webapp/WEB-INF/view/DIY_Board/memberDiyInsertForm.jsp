...
function fn_insertDIY(){
	...
	comSubmit.setUrl('/sandwich/memberDiyBoardInsert.jy');
	comSubmit.submit();
}
function fn_modifyDIY(){
	var comSubmit = new ComSubmit("diyform");
	comSubmit.setUrl('/sandwich/memberDiyBoardModify.jy');
	comSubmit.submit();
...
<span style="color:black; font-size:30px; font-weight:bold;">후기를 작성해주세요 / </span> <span style="color:#777; font-weight:bold; font-size:15px;">불타는 샌드위치</span>
</h3>
</div>
