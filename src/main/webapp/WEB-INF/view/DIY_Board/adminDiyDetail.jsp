...
<div class="notice_admin_title">
	<div class="title_font1"><a href="#" style="text-decoration: none;color:black; font-size:30px;">DIY</a></div>
...
<tr>
	<td>제목</td>
    <td colspan=3 style="background:white;">${diy.DIY_TITLE}</td>
</tr>
<tr>
	<td>작성자</td>
    <td colspan=3 style="background:white;">${diy.DIY_MEMBER_ID}</td>
</tr>

<tr>
	<td>등록일</td>
    <td style="background:white;">${diy.DIY_REGDATE}</td>
</tr>

<tr>
	<td colspan=4 style="background:white;">
	<img style="width:350px;height:250px;" src="resources/file/${diy.DIY_IMAGE}"></td>
</tr>

<tr>
	<td colspan=4 style="background:white;">${diy.DIY_CONTENT }</td>
</tr> 
</table>
...
<script>
	function goList() {
		...
		location.href = '<c:url value="/admindiyboardlist.jy"/>';
	}
</script>
