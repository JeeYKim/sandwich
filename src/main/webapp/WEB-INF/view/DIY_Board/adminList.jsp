...
<div class="title_font1"><a href="#" style="text-decoration: none;color:black;">DIY 관리자페이지</a></div>
<div class="title_font2">DIY</div>
</div>
...
<div class="row" style="font-family: PureunJeonnam;">
	<div class="panel panel-default">
		<div class="panel-heading">
                         [DIY 페이지] DIY 게시글을 검색, 수정, 삭제 기능하는 페이지입니다.
        </div>
                 	...
                 	<tr> 
                     	<td style="text-align:center;vertical-align:middle;">${stat.count}</td>
   						<td style="text-align:center;vertical-align:middle;">
                        		<a href='<c:url value="/adminDiyBoardDetail.jy?DIY_NO=${diylist.DIY_NO}"/>'>${diylist.DIY_TITLE}</a>
                        	</td>
   						<td style="text-align:center;vertical-align:middle;">${diylist.DIY_MEMBER_ID}</td>
                        <td style="text-align:center;vertical-align:middle;">${diylist.DIY_REGDATE}</td>
                        <td style="text-align:center;vertical-align:middle;">
                        
                        <button type="button" 
							onclick="goModify(${diylist.DIY_NO})"
							class="btn btn-primary" id="resister">수정</button>
							
						<button type="button"
 							onclick="goDelete(${diylist.DIY_NO})"
...
<script>
	function goWrite() {
		location.href = '<c:url value="/memberDiyBoardInsert.jy"/>';
	}
</script>

<script>
	function goModify(DIY_NO) {
		location.href = '<c:url value="/adminDiyBoardModifyForm.jy"/>'+"?DIY_NO="+DIY_NO;
	}
</script>

<script>
	function goDelete(DIY_NO) {
		location.href = '<c:url value="/adminDelete.jy"/>'+"?DIY_NO="+DIY_NO;
	}
</script> 
