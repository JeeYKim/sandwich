...
$(document).ready(function () {
	...
	$("#resister").click(function () {
			document.location.href="memberDiyBoardForm.jy";
	});
	
	
	$("#login").click(function () {
		document.location.href="loginForm.jy";
	});
	//페이지 로드시 버튼 클릭
...
<div>
	<h3 style="padding-left:20px; text-align:left;">
		<span style="color:black; font-size:30px; font-weight:bold;"><a href="memberDiyBoardList.jy">나만의 레시피</a></span> <span style=" font-size:15px; color:#777; font-weight:bold;">이렇게 드셔보세요!</span>
	</h3>
</div>
...
<c:otherwise>
<div style="padding-bottom: 70px;">
		<button type="btn btn-primary" id="login" class="btn btn-primary" style="float:right;">로그인 후 작성</button>
</div>
</c:otherwise>
</c:choose>
...
<div class="admin_search">
                     		...
                     		<div style="text-align:center; width:500px; margin-left:auto; margin-right:auto; margin-top:20px; padding-bottom:70px;">
								<div id="dataTables-example_filter" class="dataTables_filter">
									<form action="/sandwich/memberDiyBoardList.jy">
									<select class="form-control" name="searchNum" id="searchNum" style="width:100px; float:left; margin-right:8px;">
